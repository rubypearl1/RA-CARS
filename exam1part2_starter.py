...
Original file is located at
    https://colab.research.google.com/drive/1lwSWmuFN7zdTy9cblWcI7cmQfL4Hc9tH
...
plt.title("Regression Plot: Price vs Stroke")
plt.xlabel("Stroke")
plt.ylabel("Price")
plt.show()

"""Based on the correlation coefficient (~0.08),indicating a very weak linear relationship (almost none) between price and stroke. we do not expect a strong linear relationship between "stroke" and "price".
...
!jupyter nbconvert --to html Exam1Part2_RUBY_ATITSO_001423039\ \(2\).ipynb
